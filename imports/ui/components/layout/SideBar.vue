  ...
  >
    <v-list dense>
      ...
      >
        ...
        <v-list-item-content>
          <v-list-item-title v-if="link.title_i18n">{{ $t(link.title_i18n) }}</v-list-item-title>
          <v-list-item-title v-if="!link.title_i18n">{{ link.title }} </v-list-item-title>
        </v-list-item-content>
      </v-list-item>
    </v-list>
  </v-navigation-drawer>
