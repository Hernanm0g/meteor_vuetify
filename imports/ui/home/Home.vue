      ...
      <v-card>
        ...
        <v-card-text>
          <div>
            ...
            <br>
            <v-icon>link</v-icon> <a
              href="https://router.vuejs.org/"
              target="_blank"
            >Vue router</a> installed.
            <br>
            <v-icon>cloud</v-icon> <a
      ...
      <v-card>
        ...
        <v-card-text>
          <div>
            ...
            <br>
            <v-icon>person</v-icon> <a
              href="https://docs.meteor.com/api/accounts.html#Meteor-users"
              target="_blank"
            >Meteor.users.update()</a>.
            <br>
            <v-icon>face</v-icon> <a
              href="https://github.com/VeliovGroup/Meteor-Files"
              target="_blank"
            >ostrio-files</a> For avatar private links.
            <br>
            <br>
...
<script>
import { Clicks } from "/imports/api/clicks/client"
...
export default {
  ...
  meteor: {
    ...
    times(){
      const click = Clicks.findOne({});
      this.click_id = click ? click._id : undefined
      return click ? click.times : 0
    }
  },
  methods: {
    clicked(id) {
      if(!id){
        Meteor.call(
          ...
          (err,res)=>{
            if(err || !res){
              this.$store.commit("snack",{text:"error"})
              return
            }
            this.addOne(id)
          }
