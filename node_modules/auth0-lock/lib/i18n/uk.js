...
exports.default = {
  error: {
    ...
    login: {
      ...
      password_change_required: 'Вам потрібно оновити пароль, оскільки ви вперше входите в систему або оскільки термін дії пароля закінчився.', // TODO: verify error code
